    ...
    <>
      <section>
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-8 lg:px-12">
          <a href="https://github.com/BroKarim/react-iframe" className="inline-flex justify-between items-center py-1 px-2 mb-7 text-sm text-gray-700 border-black border-2 rounded-full hover:border-opacity-50 " role="alert">
            Get your code here👋
          </a>
